...
<style>
    ...
    .password-container input[type="password"] {
        padding-right: 30px; /* Để có không gian cho biểu tượng */
    }
                        ...
                        <form action="{{route('register')}}" method="POST">
                            ...
                            <div class="login-input-box">
                                ...
                                <div class="password-container">
                                    ...
                                    <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Enter the password">
