                                ...
                                <div class="col-lg-5 col-md-6 col-sm-6">
                                    ...
                                    <div class="product-large-slider">
                                        <div class="pro-large-img">
                                            <img src="{{asset('theme/client/assets/images/product/product-01.png')}}"
                                                alt="product-details" />
                                        </div>
                                        <div class="pro-large-img">
                                            <img src="{{asset('theme/client/assets/images/product/product-02.png')}}"
                                                alt="product-details" />
                                        </div>
                                        <div class="pro-large-img ">
                                            <img src="{{asset('theme/client/assets/images/product/product-03.png')}}"
                                                alt="product-details" />
                                        </div>
                                        <div class="pro-large-img">
                                            <img src="{{asset('theme/client/assets/images/product/product-04.png')}}"
                                                alt="product-details" />
                                        </div>
                                        <div class="pro-large-img">
                                            <img src="{{asset('theme/client/assets/images/product/product-05.png')}}"
                                                alt="product-details" />
                                        </div>
