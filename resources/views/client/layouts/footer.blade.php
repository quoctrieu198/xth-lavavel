            ...
            <div class="row">
                    ...
                    <div class="widget-footer mt-40">
                        ...
                        <div class="footer-addres">
                            <div class="widget-content mb--20">
                                <p>Address: Hà Nội, <br> Việt Nam.</p>
                                <p>Phone: <a href="tel:">0987654321</a></p>
                                <p>Fax: <a href="tel:">0987654321/a></p>
                                <p>Email: <a href="tel:">demo@gmail.com</a></p>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widget-footer mt-40">
                        ...
                        <ul class="footer-list">
                            <li><img src="{{asset('theme/client/assets/images/brand/img-googleplay.jpg')}}" alt=""></li>
                            <li><img src="{{asset('theme/client/assets/images/brand/img-appstore.jpg')}}" alt=""></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="copy-right-image">
                        <img src="{{asset('theme/client/assets/images/icon/img-payment.png')}}" alt="">
