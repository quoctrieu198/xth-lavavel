                    ...
                    @if($product->img_thumb . ('products/'))
                        ...
                        <div class="product-large-slider">
                            <div class="pro-large-img img-zoom">
                                <img src="{{\Illuminate\Support\Facades\Storage::url($product->img_thumb)}}"
                                    alt="product-details" />
                                <a href="{{\Illuminate\Support\Facades\Storage::url($product->img_thumb)}}"
                                ...
                                <form action="{{route('cart.add')}}" method="POST">
                                    ...
                                    <div style="margin-bottom: 10px;">
                                        <label class="form-check-label"
                                            style="display: block; margin-bottom: 5px;">Màu:</label>
                                        @foreach($colors as $id => $name)
                                            <input type="radio"
                                                style="pointer-events: none; clip: rect(0,0,0,0); position: absolute; width: 20px; height: 20px;"
                                                class="btn-check" id="radio_color_{{$id}}" name="product_color_id"
                                                value="{{$id}}">
                                            <label class="btn btn-light" for="radio_color_{{$id}}"
                                    ...
                                    <div style="margin-bottom: 10px;">
                                        <label class="form-check-label"
                                            style="display: block; margin-bottom: 5px;">Size:</label>
                                        @foreach($sizes as $id => $name)
                                            <input type="radio"
                                                style="pointer-events: none; clip: rect(0,0,0,0); position: absolute; width: 20px; height: 20px;"
                                                class="btn-check" id="radio_size_{{$id}}" name="product_size_id"
                                                value="{{$id}}">
                                            <label class="btn btn-light" for="radio_size_{{$id}}"
                                                style="padding: 5px 10px; font-size: 12px;">
                                                {{$name}}
                                            </label>
                                        @endforeach
                                    ...
                                    <div class="single-add-to-cart">
                                        <div class="quantity" style="padding-bottom: 10px">
                                            <div class="cart-plus-minus">
                                                ...
                                                <input type="number" class="input-text" name="quantity" required
                                                    value="1" title="Qty" style="width: 55px; height: 55px;  ">
                                            </div>
                                        </div>
                                    ...
                                    <div class="pro_review">
                                        <div class="review_thumb">
                                            <img alt="review images"
                                                src="{{asset('theme/client/assets/images/other/reviewer-60x60.jpg')}}">
                                        </div>
                            ...
                            <div class="product-thumb">
                                <a href="product-details.html">
                                    <img class="primary-image"
                                        src="{{asset('theme/client/assets/images/product/product-02.png')}}" alt="">
                                </a>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="single-product-area mt-30">
                            <div class="product-thumb">
                                <a href="product-details.html">
                                    <img class="primary-image"
                                        src="{{asset('theme/client/assets/images/product/product-03.png')}}" alt="">
                                </a>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="single-product-area mt-30">
                            <div class="product-thumb">
                                <a href="product-details.html">
                                    <img class="primary-image"
                                        src="{{asset('theme/client/assets/images/product/product-04.png')}}" alt="">
                                </a>
                                <div class="label-product label_new">New</div>
                                <div class="action-links">
                                    <a href="cart.html" class="cart-btn" title="Add to Cart"><i
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="single-product-area mt-30">
                            <div class="product-thumb">
                                <a href="product-details.html">
                                    <img class="primary-image"
                                        src="{{asset('theme/client/assets/images/product/product-05.png')}}" alt="">
                                </a>
                                <div class="label-product label_new">New</div>
                                <div class="action-links">
                                    <a href="cart.html" class="cart-btn" title="Add to Cart"><i
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="single-product-area mt-30">
                            <div class="product-thumb">
                                <a href="product-details.html">
                                    <img class="primary-image"
                                        src="{{asset('theme/client/assets/images/product/product-01.png')}}" alt="">
                                </a>
                                <div class="label-product label_new">New</div>
                                <div class="action-links">
                                    <a href="cart.html" class="cart-btn" title="Add to Cart"><i
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="single-product-area mt-30">
                            <div class="product-thumb">
                                <a href="product-details.html">
                                    <img class="primary-image"
                                        src="{{asset('theme/client/assets/images/product/product-12.png')}}" alt="">
                                </a>
                                <div class="label-product label_new">New</div>
                                <div class="action-links">
                                    <a href="cart.html" class="cart-btn" title="Add to Cart"><i
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="single-product-area mt-30">
                            <div class="product-thumb">
                                <a href="product-details.html">
                                    <img class="primary-image"
                                        src="{{asset('theme/client/assets/images/product/product-13.png')}}" alt="">
                                </a>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="single-product-area mt-30">
                            <div class="product-thumb">
                                <a href="product-details.html">
                                    <img class="primary-image"
                                        src="{{asset('theme/client/assets/images/product/product-14.png')}}" alt="">
                                </a>
                                <div class="label-product label_new">New</div>
                                <div class="action-links">
                                    <a href="cart.html" class="cart-btn" title="Add to Cart"><i
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="single-product-area mt-30">
                            <div class="product-thumb">
                                <a href="product-details.html">
                                    <img class="primary-image"
                                        src="{{asset('theme/client/assets/images/product/product-15.png')}}" alt="">
                                </a>
                                <div class="label-product label_new">New</div>
                                <div class="action-links">
                                    <a href="cart.html" class="cart-btn" title="Add to Cart"><i
