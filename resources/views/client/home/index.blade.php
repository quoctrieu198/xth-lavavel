...
{{--            <!-- Single Slide Start -->--}}
{{--            <div class="single-slide" style="background-image: url({{asset('theme/client/assets/images/slider/slide-bg-2.jpg')}})">--}}
...
{{--            <!-- Single Slide Start -->--}}
{{--            <div class="single-slide" style="background-image: url({{asset('theme/client/assets/images/slider/slide-bg-1.jpg')}})">--}}
{{--                <!-- Hero Content One Start -->--}}
{{--                <div class="hero-content-one container">--}}
{{--                    <div class="row">--}}
{{--                        <div class="col-lg-12 col-md-12">--}}
...
{{--                            <a href="#"><img src="{{asset('theme/client/assets/images/banner/banner-01.jpg')}}" alt=""></a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <div class="col-lg-6  col-md-6">--}}
{{--                        <div class="single-banner mb-30">--}}
{{--                            <a href="#"><img src="{{asset('theme/client/assets/images/banner/banner-02.jpg')}}" alt=""></a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="single-product-area mt-30">
                            ...
                            <div class="product-caption">
                                <h4 class="product-name"><a href="{{route('client.home.show',$item)}}">{{$item->name}}</a></h4>
                                <div class="price-box">
                            ...
                            <div class="row product-active-row-4">
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-area mt-30">
                                        <div class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="primary-image" src="{{asset('theme/client/assets/images/product/product-20.png')}}" alt="">
                                            </a>
                                            <div class="label-product label_new">New</div>
                                            <div class="action-links">
                                                <a href="cart.html" class="cart-btn" title="Add to Cart"><i class="icon-basket-loaded"></i></a>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-area mt-30">
                                        <div class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="primary-image" src="{{asset('theme/client/assets/images/product/product-06.png')}}" alt="">
                                            </a>
                                            <div class="action-links">
                                                <a href="cart.html" class="cart-btn" title="Add to Cart"><i class="icon-basket-loaded"></i></a>
                                                <a href="wishlist.html" class="wishlist-btn" title="Add to Wish List"><i class="icon-heart"></i></a>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-area mt-30">
                                        <div class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="primary-image" src="{{asset('theme/client/assets/images/product/product-07.png')}}" alt="">
                                            </a>
                                            <div class="label-product label_new">New</div>
                                            <div class="action-links">
                                                <a href="cart.html" class="cart-btn" title="Add to Cart"><i class="icon-basket-loaded"></i></a>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-area mt-30">
                                        <div class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="primary-image" src="{{asset('theme/client/assets/images/product/product-08.png')}}" alt="">
                                            </a>
                                            <div class="label-product label_new">New</div>
                                            <div class="action-links">
                                                <a href="cart.html" class="cart-btn" title="Add to Cart"><i class="icon-basket-loaded"></i></a>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-area mt-30">
                                        <div class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="primary-image" src="{{asset('theme/client/assets/images/product/product-09.png')}}" alt="">
                                            </a>
                                            <div class="action-links">
                                                <a href="cart.html" class="cart-btn" title="Add to Cart"><i class="icon-basket-loaded"></i></a>
                                                <a href="wishlist.html" class="wishlist-btn" title="Add to Wish List"><i class="icon-heart"></i></a>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-area mt-30">
                                        <div class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="primary-image" src="{{asset('theme/client/assets/images/product/product-10.png')}}" alt="">
                                            </a>
                                            <div class="label-product label_new">New</div>
                                            <div class="action-links">
                                                <a href="cart.html" class="cart-btn" title="Add to Cart"><i class="icon-basket-loaded"></i></a>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-area mt-30">
                                        <div class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="primary-image" src="{{asset('theme/client/assets/images/product/product-11.png')}}" alt="">
                                            </a>
                                            <div class="label-product label_new">New</div>
                                            <div class="action-links">
                                                <a href="cart.html" class="cart-btn" title="Add to Cart"><i class="icon-basket-loaded"></i></a>
                            ...
                            <div class="row product-active-row-4">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-area mt-30">
                                        <div class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="primary-image" src="{{asset('theme/client/assets/images/product/product-17.png')}}" alt="">
                                            </a>
                                            <div class="label-product label_new">New</div>
                                            <div class="action-links">
                                                <a href="cart.html" class="cart-btn" title="Add to Cart"><i class="icon-basket-loaded"></i></a>
                            ...
                            <div class="row product-active-row-4">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-area mt-30">
                                        <div class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="primary-image" src="{{asset('theme/client/assets/images/product/product-19.png')}}" alt="">
                                            </a>
                                            <div class="label-product label_new">New</div>
                                            <div class="action-links">
                                                <a href="cart.html" class="cart-btn" title="Add to Cart"><i class="icon-basket-loaded"></i></a>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-area mt-30">
                                        <div class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="primary-image" src="{{asset('theme/client/assets/images/product/product-18.png')}}" alt="">
                                            </a>
                                            <div class="action-links">
                                                <a href="cart.html" class="cart-btn" title="Add to Cart"><i class="icon-basket-loaded"></i></a>
                                                <a href="wishlist.html" class="wishlist-btn" title="Add to Wish List"><i class="icon-heart"></i></a>
